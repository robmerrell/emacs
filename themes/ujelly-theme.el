...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   '(company-scrollbar-bg ((t (:inherit company-tooltip :background "#1584D0"))))
   '(company-tooltip ((t (:background "#0D5180" :foreground "#ffffff"))))
   '(company-tooltip-selection ((t (:inherit company-tooltip :background "#1584D0"))))
   ...
   `(mode-line ((t (:foreground "#fcfcfc" :background "#0676bb" :box nil))))
